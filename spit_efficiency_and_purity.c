...
void spit_efficiency_and_purity(const std::string& microtree_file, const int branch = 0){
  ...
  DataSample* magnet_mc_run2a  = new DataSample("/data/aspeers/4pi_Selection/mcp/microTrees/P7_V12_FHC_length_fix_default_settings.root");
