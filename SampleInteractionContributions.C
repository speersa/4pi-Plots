...
void SampleInteractionContributions() {
	gROOT->SetBatch();
	...
	draw->PrintPurities(mc, "reaction", "accum_level[0][0]>8");
	
	cout << std::endl <<  "CC0piNp Fwd" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][1]>8");
	
	cout << std::endl << "CC0pi0p Bwd" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][2]>8");
	
	cout << std::endl << "CC0piNp Bwd" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][3]>8");
	
	cout << std::endl << "CC0pi0p HAFwd" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][4]>8");
	
	cout << std::endl << "CC0piNp HAFwd" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][5]>8");
	
	cout << std::endl << "CC0pi0p HABwd" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][6]>8");
	
	cout << std::endl << "CC0piNp HABwd" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][7]>8");
	
	cout << std::endl << "CC1pi" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][8]>7");
	
	cout << std::endl << "CC1pi HAFwd" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][9]>7");
	
	cout << std::endl << "CCOther" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][10]>7");
	
	cout << std::endl << "CC-Photon" << std::endl;
	draw->PrintPurities(mc, "reaction", "accum_level[0][11]>6");	
